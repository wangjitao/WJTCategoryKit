...
- (void)addParallaxWithView:(UIView*)view andHeight:(CGFloat)height {
    ...
    [self addParallaxWithView:view andHeight:height andWidth:self.bounds.size.width];
}

- (void)addParallaxWithView:(UIView*)view andHeight:(CGFloat)height andWidth:(CGFloat)width {
    if(self.parallaxView) {
        [self.parallaxView.currentSubView removeFromSuperview];
    ...
    {
        APParallaxView *parallaxView = [[APParallaxView alloc] initWithFrame:CGRectMake(0, 0, width, height)];
